...
export const Criteria: React.FC = () => {
  return (
    <div className=" border-t-[0.1px] border-[#2e2053] relative md:pt-20">
        ...
        <div className="relative flex-1 text-center md:text-left z-40">
          <SlideUp>
            ...
            <ul className="relative z-30">
              ...
              {attributes.map((attr) => (
                <li className="pb-5 leading-5 text-xs montserrat" key={attr.id}>
                  {" "}
      ...
      <PurpleBg className="absolute top-0 bottom-32 z-10" />
      <BlinkingStar colour="purple" className="absolute top-20 left-40" />
      <BlinkingStar colour="gray" className="absolute bottom-10 right-[55%] z-40"/>
