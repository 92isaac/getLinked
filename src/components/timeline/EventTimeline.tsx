  ...
  return (
    <div className="px-5 mt-5 mb-16 md:px-20">
      ...
      <div className="text-center">
        <h2 className="class-display font-bold text-lg md:text-2xl">Timeline</h2>
      ...
      {isSmallScreen ? (
        <div className="relative grid md:grid-cols-2 md:pt-20 gap-x-32 pl-6 md:px-20 text-sm">
          <div className="absolute md:left-1/2 top-6">
            ...
            <Millestone
              className="absolute top-[10%] -left-4 text-sm text-center leading-7"
              smallCircle="w-6 h-6"
              bigCircle="w-8 h-8"
              content="1"
            />
            <Millestone
              className="absolute top-[26%] -left-4 text-sm text-center leading-7"
              smallCircle="w-6 h-6"
              bigCircle="w-8 h-8"
              content="2"
            />
            <Millestone
              className="absolute top-[40%] -left-4 text-sm text-center leading-7"
              smallCircle="w-6 h-6"
              bigCircle="w-8 h-8"
              content="3"
            />
            <Millestone
              className="absolute top-[60%] -left-4 text-sm text-center leading-7"
              smallCircle="w-6 h-6"
              bigCircle="w-8 h-8"
              content="4"
            />
            ...
            />
            <Millestone
              className="absolute md:top-[96%] -left-4 text-sm text-center leading-7"
              smallCircle="w-6 h-6"
              bigCircle="w-8 h-8"
              content="6"
            />
