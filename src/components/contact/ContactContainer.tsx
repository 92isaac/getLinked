  ...
  return (
    <div className="md:flex justify-between items-center md:px-32">
      <div className="hidden md:block flex-1 px-5 text-xs montserrat">
        <h2 className="class-display text-lg text-[#d434fe] font-bold">
          Get in touch
        </h2>
        <p className="mt-4">
          Contact <br />
      ...
      <div className="px-5 md:hidden" onClick={()=>{navigate(-1)}}>
      ...
      >
        ...
        <div className="md:hidden flex justify-center pb-5 items-center">
          <div className="mt-4">
            <span className="text-[#d434fe] block text-sm text-center font-bold">Follow us</span>
